...
// 1. Leer el archivo CSV usando la API nativa de Bun
const file = Bun.file("../data/estudiantes.csv");
...
// 5. Estructurar el JSON (Cambiamos el runtime a "bun")
const outputJson = {
    runtime: "bun",
    tiempoMs: tiempoMs,
...
// 6. Escribir el archivo JSON usando la API nativa de Bun
await Bun.write("../output/resultado-bun.json", JSON.stringify(outputJson, null, 2));

// 7. Imprimir resultados
console.log(`⏱️  Tiempo total Bun: ${tiempoMs} ms`);
